...
//        fileAndDirFilter.setFilterDirNames(Set.of(""));
    ...
    public void genDirMd5VersionTagLen() throws Exception {
        ...
        var zipConfig = new ZipConfig()
                ...
                .setPassword("123")
                .setDelZip(false);
        String md5FileStr=dirCompareService.genDirMd5VersionTag(sourceDirPath.toFile(),sourceDirPath.toFile(), VersionType.LEN);
    ...
    public void genDirMd5VersionTagMd5() throws Exception {
        ...
        var zipConfig = new ZipConfig()
                ...
                .setPassword("123")
                .setDelZip(false);
        String md5FileStr=dirCompareService.genDirMd5VersionTag(sourceDirPath.toFile(),sourceDirPath.toFile(), VersionType.MD5);
        Assert.assertEquals(md5, FileStrStore.getValue(Path.of(md5FileStr)));
    }
    @After
